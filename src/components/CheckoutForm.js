...
const renderField = field => {
    ...
    const inputClassName = `form-control no-border ${
        touchedAndInvalid ? 'is-invalid' : ''
        }`;

    return (
        <FormGroup className="hide" row>
                ...
                <CardDeck>
                    <Card className="">
                        <CardBody>
                            ...
                            <CardText>{addressText.filter(text => typeof text === 'string' && text.trim().length).join(', ')}
                            </CardText>
                            <CardText>{this.props.additionalAddressInfo}</CardText>
                            {this.props.emailAddress && <CardText>{this.props.emailAddress || ''}</CardText>}
                        </CardBody>
                    </Card>
                </CardDeck>
                <br/>
